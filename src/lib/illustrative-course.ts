...
export function buildIllustrativeCourseTemplate(origin: string, assets: IllustrativeTemplateAssets): IllustrativeCourseTemplate {
  ...
  const design: CourseDesign = {
    ...
    certificateFeeGhs: 0,
    creditValue: 0,
    programmeInitiationSource: "code",
    originatingUnit: "College of Distance Education",
    programmeHome: "College of Distance Education",
    contributingUnits: ["School of Business", "Department of Computer Science and Information Technology"],
    identifiedNeed: "Illustrative cross-disciplinary data-literacy and decision-making need used to demonstrate a complete UCC micro-credential design record.",
