...
declare global { var __uccRenderDb: RenderDatabase | undefined; }

export function getRawDb() {
  if (globalThis.__uccRenderDb) return globalThis.__uccRenderDb;
  ...
  globalThis.__uccRenderDb = new RenderDatabase(database);
  return globalThis.__uccRenderDb;
}
